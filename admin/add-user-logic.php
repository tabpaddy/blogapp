...
// get form data if sign  button is click.
if(isset($_POST['submit'])){
    ...
    if(isset($_SESSION['add-user'])) {
        ...
        $insert_user_query = "INSERT INTO users (firstname, lastname, username, email, password, avatar, is_admin) VALUES('$firstname','$lastname', '$username', '$email', '$hashed_password', '$avatar_name', $userrole)";
        $insert_user_result= mysqli_query($con, $insert_user_query);
        if(!mysqli_errno($con)){
            // redirct to login page with success message
            $_SESSION['add-user-success'] = "User $firstname $lastname Added Successful.";
